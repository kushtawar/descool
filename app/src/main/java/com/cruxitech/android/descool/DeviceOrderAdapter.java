...
public class DeviceOrderAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_alldevices, null);
        }
     ...
     //       lv.setEmptyView(nodatadisplaytextview);
            ...
            TextView devtypeview = (TextView) convertView.findViewById(R.id.devtype);
            TextView devnoview = (TextView) convertView.findViewById(R.id.devno);
            TextView devownerview = (TextView) convertView.findViewById(R.id.devowner);
